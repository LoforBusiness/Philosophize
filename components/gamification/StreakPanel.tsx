...
//
//   THE SPARK        constants/streak.ts carries the palette's ember, whose entire
...
// see STREAK_ON_INK: the ember measured for paper reads 2.6:1 on ink, under the floor
...
export default function StreakPanel({
  ...
  const mark = onInk ? (alive ? STREAK_ON_INK : SLATE_LIT) : alive ? STREAK_EMBER : SLATE;
  ...
  // inverts correctly and a lapsed run is struck in slate rather than in the ember.
