...
const ART: Record<TabIconName, Art> = {
  ...
  insights: {
    body: [
      'M5 27 L5 20.6 C5 19.7 5.7 19 6.6 19 L9.4 19 C10.3 19 11 19.7 11 20.6 L11 27 Z',
      'M13 27 L13 15.6 C13 14.7 13.7 14 14.6 14 L17.4 14 C18.3 14 19 14.7 19 15.6 L19 27 Z',
      'M21 27 L21 10.6 C21 9.7 21.7 9 22.6 9 L25.4 9 C26.3 9 27 9.7 27 10.6 L27 27 Z',
    ],
    lines: ['M3 27.6 L29 27.6'],
    flourish: ['M15.6 3.2 L16.5 5.5 L18.8 6.4 L16.5 7.3 L15.6 9.6 L14.7 7.3 L12.4 6.4 L14.7 5.5 Z'],
  },
