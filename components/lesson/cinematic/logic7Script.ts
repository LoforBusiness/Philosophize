...
export const BEATS: Logic7Beat[] = [
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'Certainly not, and no sky needed. The rule promised that rain brings wet streets every time. So a dry street is not weak evidence about the rain. It rules the rain out, because a rainy night with dry streets would break the rule.',
      xp: 5,
    },
    dur: 1.0,
  },
