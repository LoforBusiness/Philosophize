...
// pays out in the palette's own struck teal with a small burst when the answer is
// right, the same material the Pass and first place are struck in. Both are
...
/**
 * THE PAYOUT. A teal coin reading the XP a correct answer earns, which pops and
