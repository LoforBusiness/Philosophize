...
export const BEATS: Political8Beat[] = [
  ...
  },
  {
    ...
    interact: {
      ...
      poll: {
        options: [
          { id: 'crates', reads: 'identical crates, and one person staring at wood', correct: true },
          { id: 'aim', reads: 'different shares, and everybody can see: the aim' },
          { id: 'lucky', reads: 'identical shares that happened to work for all' },
