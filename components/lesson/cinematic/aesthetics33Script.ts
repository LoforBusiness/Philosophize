...
export const BEATS: Aesthetics33Beat[] = [
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'Where the certainty stops. Nobody defends leaving the soot, and nobody defends going through the paint. The whole argument is about the layer in between. The reason to stop there is not taste. It’s that you can’t put it back.',
      xp: 5,
    },
    dur: 1.0,
  },
  ...
  },
  {
    summary: {
      ...
      closing: 'Every old painting you’ve seen is partly a set of decisions somebody made about what it was.',
    },
    dur: 3.0,
  },
];
