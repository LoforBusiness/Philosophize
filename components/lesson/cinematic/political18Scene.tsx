...
export default function Political18Scene({ clock, bt, bi, i, picked, onPick, dragPos, pickPos, gazeX, gazeY, gazeOn }: SceneApi) {
  ...
  const SCENE = useDerivedValue(() => {
    ...
    return {
      ...
      ride: carry(cv, 2, n, RIDE[p], reacting ? pickPos.value : RIDE[n], roll),
