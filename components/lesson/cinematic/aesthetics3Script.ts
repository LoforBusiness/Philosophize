...
// A figure is moved by music that streams up on either side of it — sways to it,
// clutches its chest at a tragedy's pity and fear (a theatre mask looks on), then
// opens into a cathartic release. Notes flank the figure so they never cross it.
//
