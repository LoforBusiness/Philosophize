...
export const BEATS: Met22Beat[] = [
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'Something earlier. Given the laws, a different outcome needs a different run-up. That’s why people look for their freedom at the junction and can’t find it there. The junction is where the branch is, not where the difference would have to be.',
      xp: 5,
    },
    dur: 1.0,
  },
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'If you had wanted. Compatibilism keeps the replay and rereads the phrase: you were free if nothing stopped you acting on what you wanted. The libertarian answer is “same past, other choice”. It has to explain why a replay that could go either way isn’t just luck.',
      xp: 5,
    },
    dur: 1.0,
  },
  {
    summary: {
      ...
      closing: 'The fight is not about what happened. It’s about what “could have” meant.',
    },
    dur: 3.6,
  },
];
