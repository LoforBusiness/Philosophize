...
const styles = StyleSheet.create({
  ...
  flagSub: {
    fontFamily: 'Inter_400Regular', fontSize: 8.5, lineHeight: 11.5, color: SOFT,
...
export function Epistemology10Lesson({ lesson }: { lesson: Lesson }) {
  return <CinematicPlayer lesson={lesson} beats={BEATS} Scene={Epistemology10Scene} band={[256, 512]} />;
}
