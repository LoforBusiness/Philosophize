...
export const BEATS: Log20Beat[] = [
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'The board on a single leg. That board falls the moment anything touches it. That’s why knocking it down is tempting, and why the win settles nothing. The other two boards are still standing, and neither has been answered.',
      xp: 5,
    },
    dur: 1.0,
  },
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'The best case. Answering what they said is honest, but still not enough. A poorly put case can be repaired, and the repair is what you’ll meet next. Beat the best version and every weaker one falls with it.',
      xp: 5,
    },
    dur: 1.0,
  },
  {
    summary: {
      ...
      closing: 'You’re not ready to answer the other side until you can state their case better than they did.',
    },
    dur: 3.4,
  },
];
