...
export const BEATS: Epistemology34Beat[] = [
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'Learning more is a fine thing and it’s slow. Lowering an inflated claim closes the same gap tonight, without a single new fact. That’s only strange until you remember calibration was a match, never a score.',
      xp: 5,
    },
    dur: 1.0,
  },
  {
    summary: {
      ...
      closing: 'Certainty is a feeling with a track record. It’s worth knowing what yours is.',
    },
    dur: 3.0,
  },
];
