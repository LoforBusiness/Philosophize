...
export const BEATS: Logic33Beat[] = [
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'The middle, and both ends fail for opposite reasons. Too straight and it misses structure that’s really there. Too bendy and it fits your measurement errors as carefully as your measurements.',
      xp: 5,
    },
    dur: 1.0,
  },
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'The razor only chooses between accounts that fit equally well. A straight line drawn through curved data isn’t admirably economical. It’s false. That’s why the rule ends “but not simpler”.',
      xp: 5,
    },
    dur: 1.0,
  },
  {
    summary: {
      ...
      closing: 'Ask how much of an explanation is doing work, and how much is there to cover one awkward fact.',
    },
    dur: 3.0,
  },
];
