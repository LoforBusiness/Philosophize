...
export const BEATS: Political36Beat[] = [
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'Nothing was banned and nobody was charged. The windows went out anyway, because people stopped doing things that would be awkward to explain. That’s the whole mechanism, and it runs on innocent behaviour.',
      xp: 5,
    },
    dur: 1.0,
  },
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'Not knowing. A law is arguable and an arrest is news. Uncertainty needs neither. If you can’t tell whether anyone is looking, the safe assumption is that they are. That costs the watcher nothing.',
      xp: 5,
    },
    dur: 1.0,
  },
  ...
  },
  {
    summary: {
      ...
      closing: 'A society can be free on paper and narrower in daily life. The narrowing shows up in nobody’s numbers.',
    },
    dur: 3.2,
  },
];
