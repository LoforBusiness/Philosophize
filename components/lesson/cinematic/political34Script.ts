...
export const BEATS: Political34Beat[] = [
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'Match the ring to the reach. Decide too small and you impose on people downstream who had no vote. Decide too large and the room deciding has authority without knowing the place it’s deciding about.',
      xp: 5,
    },
    dur: 1.0,
  },
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'A village dumping waste in the river is deciding very locally about effects that aren’t local at all. Everyone downstream is governed by a vote they were never in. Local is a floor, not the whole rule.',
      xp: 5,
    },
    dur: 1.0,
  },
  {
    summary: {
      ...
      closing: 'Next time a political argument stalls, check whether the real quarrel is about who gets to answer.',
    },
    dur: 3.0,
  },
];
