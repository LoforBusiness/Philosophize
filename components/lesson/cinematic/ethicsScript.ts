...
export const BEATS: EthicsBeat[] = [
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'Apes show empathy and fairness too, so empathy isn’t the difference. Humans add language, and the step back to ask “was that right?”',
      xp: 5,
    },
    dur: 1.0,
  },
  {
    ...
    interact: {
      ...
      explain: 'Most of the way, and the last stretch is the difference. Apes have the building blocks — empathy, a keen sense of fairness, distress at cruelty. What’s missing is the step out: putting it in words and asking yourself whether that was right.',
      xp: 5,
    },
    dur: 1.0,
  },
