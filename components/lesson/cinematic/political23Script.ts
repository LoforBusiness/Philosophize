...
export const BEATS: Pol23Beat[] = [
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'Being a daughter. You can leave a club and change careers, and no act of yours began the first tie. The point isn’t that the tie binds harder. The point is that you found yourself already inside it, before any choosing began.',
      xp: 5,
    },
    dur: 1.0,
  },
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'Nearly all handed over. The claim isn’t that you never choose. It’s that the chooser was built out of a language, a family and a place. No earlier self did the picking. The liberal reply is that you can still walk away.',
      xp: 5,
    },
    dur: 1.0,
  },
  {
    summary: {
      ...
      closing: 'Strip away everything you didn’t choose, and the argument is about what’s left.',
    },
    dur: 3.6,
  },
];
