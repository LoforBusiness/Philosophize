...
const styles = StyleSheet.create({
  ...
  edgeText: { fontFamily: 'Inter_700Bold', fontSize: 10.3, letterSpacing: 1.6, color: SOFT,
  ...
  sliceSub: { fontFamily: 'Inter_400Regular', fontSize: 10.3, letterSpacing: 0.4, color: SOFT, marginTop: 3,
    includeFontPadding: false,
  },
  sliceLabelOn: { fontFamily: 'Inter_700Bold', fontSize: 14, letterSpacing: 1.2, color: PAPER,
    includeFontPadding: false,
  },
  sliceSubOn: { fontFamily: 'Inter_400Regular', fontSize: 10.3, letterSpacing: 0.4, color: RULE, marginTop: 3,
    includeFontPadding: false,
  },
  ...
  ringLabel: {
    ...
    fontFamily: 'Inter_700Bold', fontSize: 10.3, letterSpacing: 1.6, color: SOFT,
    includeFontPadding: false,
  },
  ...
  pickLabel: {
    ...
    fontFamily: 'Inter_700Bold', fontSize: 10.3, letterSpacing: 1.5, color: INK,
    includeFontPadding: false,
  },
