...
export const BEATS: Aesthetics30Beat[] = [
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'Attending to something real. The ego steps back because the bird has taken the room, which is not the same as forgetting who you are or deciding you do not matter. Murdoch calls the shift moral training for attending to other people.',
      xp: 5,
    },
    dur: 1.0,
  },
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'Almost all of it on the world. Murdoch calls beauty the checking of selfishness, so a reader still monitoring themselves has not been unselfed at all. The bird is doing the work, and it can only do the work while it is what you are looking at.',
      xp: 5,
    },
    dur: 1.0,
  },
  {
    ...
    summary: {
      ...
      closing: 'You have learned what beauty is. The last lesson is to let it stop you in your tracks.',
    },
    dur: 5.0,
  },
];
