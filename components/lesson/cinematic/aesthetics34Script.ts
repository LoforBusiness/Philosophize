...
export const BEATS: Aesthetics34Beat[] = [
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'You can go to the end of the rail and it never stops pointing. That’s not a trick. It’s what a vague boundary looks like from the inside. Hunting for the exact stroke is like hunting for the grain that ends a heap.',
      xp: 5,
    },
    dur: 1.0,
  },
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'The trap is reading a fuzzy border as no border at all. There’s no exact grain where a heap begins either, and heaps are real. The first plate is a bull and so is the eleventh. The trouble is only in saying where the edge went.',
      xp: 5,
    },
    dur: 1.0,
  },
