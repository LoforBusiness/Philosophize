...
export const BEATS: Epistemology41Beat[] = [
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'The middle one. Nobody disputes the look, and nobody disputes the oar — the argument would be pointless if either were in doubt. What gets refused is the slide from something looks bent to a bent something is here.',
      xp: 5,
    },
    dur: 1.0,
  },
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'The oar. Things look different from different places, and a kink at the waterline is one of the ways a straight oar looks. The sense-datum buys a tidy story dearly: once you only ever meet the stand-in, the oar itself becomes a guess.',
      xp: 5,
    },
    dur: 1.0,
  },
  {
    ...
    summary: {
      ...
      closing: 'Whichever way you go, notice how much theory was hiding inside a sentence that sounded like a plain description of a boat.',
    },
    dur: 4.6,
  },
];
