...
export const BEATS: AestheticsBeat[] = [
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'Nearly all the way over, which is the strange part. The word “felt” sounds merely private, and that’s the slip. Look at the two rows. “I like it” needs one person, and “it is beautiful” summons eight. A judgement of taste is a feeling that behaves like a claim.',
      xp: 5,
    },
    dur: 1.0,
  },
