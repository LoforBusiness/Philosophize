...
export const BEATS: Ethics31Beat[] = [
  ...
  },
  {
    ...
    interact: {
      ...
      poll: {
        options: [
          { id: 'own', reads: 'you could not, and you arranged that', correct: true },
          { id: 'excused', reads: 'you could not, through nothing you did: excused' },
          { id: 'plain', reads: 'you could have, and simply did not: answerable' },
