...
export const BEATS: Metaphysics39Beat[] = [
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'The gardener, and no fact about the plant says so. A neighbour may have stood nearer and a stranger may have seen it was dry. What separates the gardener from the other three is a job, which is not a feature of the soil.',
      xp: 5,
    },
    dur: 1.0,
  },
  ...
  },
  {
    ...
    interact: {
      ...
      explain: 'Almost all of it is the expectation. Hand the bar to the physics and watch all four runs come back: that is what the world alone can tell you. The plant still died of thirst. Naming one absence is a further step, and it goes through a duty.',
      xp: 5,
    },
    dur: 1.0,
  },
  {
    summary: {
      ...
      closing: 'Next time a report blames somebody for not acting, ask who else did not act. The list is always long, and what shortens it is never physics.',
    },
    dur: 3.4,
  },
];
