...
export interface Aes11Beat extends BaseBeat {
  ...
  /** 1 = a small gauge beside the figure fills almost instantly, showing how fast the machine worked. */ gen?: number;
  /** 1 = a matching registration mark appears at the same point on both canvases, at once. */ mark?: number;
}
