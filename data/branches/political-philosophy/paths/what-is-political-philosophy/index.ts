...
import theEmptyChairs from './lessons/the-empty-chairs';
...
import whenTheRulesAreSuspended from './lessons/when-the-rules-are-suspended';
import whatMoneyShouldNotBuy from './lessons/what-money-should-not-buy';
