...
export const LESSON_FOCUS: Record<string, LessonFocus> = {
  ...
  'metaphysics-being-40': { beat: 5, phrase: 'Tomorrow\'s line is neither true nor false yet' },
  ...
  'ethics-ethics-40': { beat: 5, phrase: 'A want is a stake, not a feeling' },
  'aesthetics-aesthetics-40': { beat: 3, phrase: 'Eating does not leave the dinner standing' },
  'political-political-40': { beat: 3, phrase: 'Some things are changed by being priced' },
  'metaphysics-being-41': { beat: 2, phrase: 'No things, no space' },
  'epistemology-knowledge-41': { beat: 2, phrase: 'What you see is bent, and the oar is not' },
  'logic-arguments-41': { beat: 3, phrase: 'The second group sits inside the first' },
  'ethics-ethics-41': { beat: 7, phrase: 'Only the resting answer changed' },
  'aesthetics-aesthetics-41': { beat: 1, phrase: 'The frame is the trouble' },
  'political-political-41': { beat: 3, phrase: 'The power has an owner and a purpose' },
  'metaphysics-being-26': { beat: 1, phrase: 'Somewhere between the parts and the whole it arrived' },
  'epistemology-knowledge-26': { beat: 5, phrase: 'The disagreement is itself a piece of evidence' },
  'logic-arguments-24': { beat: 7, phrase: 'A guaranteed conclusion tells you nothing new' },
  'ethics-ethics-26': { beat: 5, phrase: 'Person and human come apart' },
  'aesthetics-aesthetics-26': { beat: 3, phrase: 'Kitsch is sincere, and camp is a wink' },
  'political-political-26': { beat: 0, phrase: 'A vote can count millions of opinions and weigh not one of them' },
  ...
  'logic-arguments-27': { beat: 3, phrase: 'An ordinary sentence describes the world; this one describes itself' },
  'ethics-ethics-27': { beat: 7, phrase: 'the bill falls due when two moralities collide' },
  'aesthetics-aesthetics-27': { beat: 3, phrase: 'You stop seeing what you have seen a thousand times' },
  'political-political-27': { beat: 1, phrase: 'hangs two gates across one road' },
  'metaphysics-being-28': { beat: 3, phrase: 'Panpsychism fills the gap with experience' },
  'epistemology-knowledge-28': { beat: 0, phrase: 'Sometimes it is a lawyer with the verdict already chosen' },
  'logic-arguments-28': { beat: 3, phrase: 'One difference that matters can sink the whole argument' },
  'ethics-ethics-28': { beat: 7, phrase: 'Nothing in it is the unshakeable floor' },
  ...
  'aesthetics-aesthetics-29': { beat: 3, phrase: 'A novel puts you inside it for four hundred pages' },
  'political-political-29': { beat: 3, phrase: 'An inherited status that shapes a life, handed out by birth' },
  'metaphysics-being-30': { beat: 5, phrase: 'Travellers who come later start from your map rather than from nothing' },
  'epistemology-knowledge-30': { beat: 2, phrase: 'Good intellectual character is the skill' },
  'logic-arguments-30': { beat: 7, phrase: 'Build the strongest version and answer that one' },
  'ethics-ethics-30': { beat: 7, phrase: 'no formula breaks the tie' },
  'aesthetics-aesthetics-30': { beat: 5, phrase: 'Beauty can land like an event' },
