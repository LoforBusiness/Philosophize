...
export const VISITOR: Record<string, VisitorCue> = {
  ...
  'metaphysics-being-39': { enter: 6, x: 199, from: -60, dir: -1 },
  'logic-arguments-38': { enter: 6, x: 39, from: -60, dir: 1 },
  'logic-arguments-16': { enter: 8, x: 346, from: 460, dir: -1 },
  ...
  'aesthetics-aesthetics-21': { enter: 7, x: 124, from: -60, dir: 1 },
  'logic-arguments-19': { enter: 6, x: 351, from: 460, dir: -1 },
  'logic-arguments-21': { enter: 7, x: 123, from: -60, dir: 1 },
  'epistemology-knowledge-23': { enter: 6, x: 357, from: 460, dir: -1 },
  'epistemology-knowledge-25': { enter: 8, x: 37, from: -60, dir: 1 },
  ...
  'ethics-ethics-37': { enter: 4, x: 263, from: 460, dir: -1 },
  'aesthetics-aesthetics-38': { enter: 6, x: 38, from: -60, dir: 1 },
  'logic-arguments-23': { enter: 8, x: 281, from: 460, dir: -1 },
  'metaphysics-being-13': { enter: 6, x: 42, from: -60, dir: 1 },
  'political-political-15': { enter: 5, x: 44, from: -60, dir: 1 },
  'epistemology-knowledge-2': { enter: 7, x: 302, from: 460, dir: -1 },
  'metaphysics-being-8': { enter: 12, x: 97, from: -60, dir: 1 },
  'political-political-11': { enter: 10, x: 47, from: -60, dir: 1 },
  'ethics-ethics-14': { enter: 7, x: 257, from: 460, dir: -1 },
  'metaphysics-being-40': { enter: 7, x: 41, from: -60, dir: 1 },
  'logic-arguments-40': { enter: 7, x: 36, from: -60, dir: 1 },
  'ethics-ethics-40': { enter: 7, x: 34, from: -60, dir: 1 },
  'metaphysics-being-26': { enter: 7, x: 30, from: -60, dir: 1 },
  'political-political-26': { enter: 7, x: 32, from: -60, dir: 1 },
