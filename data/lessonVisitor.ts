...
export const VISITOR: Record<string, VisitorCue> = {
  'political-political-4': { enter: 8, x: 286, from: 460, dir: -1 },
  'ethics-ethics-7': { enter: 10, x: 253, from: 460, dir: -1 },
  'ethics-ethics-31': { enter: 8, x: 45, from: -60, dir: 1 },
  'logic-arguments-16': { enter: 8, x: 56, from: -60, dir: 1 },
  'logic-arguments-17': { enter: 8, x: 357, from: 460, dir: -1 },
  ...
  'epistemology-knowledge-23': { enter: 6, x: 351, from: 460, dir: -1 },
  'metaphysics-being-21': { enter: 8, x: 50, from: -60, dir: 1 },
  ...
  'political-political-13': { enter: 9, x: 40, from: -60, dir: 1 },
  'political-political-15': { enter: 5, x: 44, from: -60, dir: 1 },
  'epistemology-knowledge-2': { enter: 7, x: 43, from: -60, dir: 1 },
  'metaphysics-being-8': { enter: 12, x: 102, from: -60, dir: 1 },
  'ethics-ethics-14': { enter: 7, x: 254, from: 460, dir: -1 },
};
